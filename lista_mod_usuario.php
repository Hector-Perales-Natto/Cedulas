...
<body>
	<div class="container  my-5">
            ...
            <form method="POST" action="" onSubmit="return validarForm(this)"> 
                <input type="text" class="form-control" placeholder="Buscar usuario" name="palabra" style="width: 90%; display: inline-block; margin-bottom: 10px;"> 
            ...
            if($_GET['pagina']>$paginas || $_GET['pagina']<=0) {
                echo "<script>location.href = 'lista_mod_usuario.php?pagina=1';</script>";
            }
            ...
            <table class="table table-striped table-bordered">
                ...
                ?>     
                    <tr>
                        <td style="text-align: center; width: 33.3%;"><a href="modUsuario.php?recordID=<?php echo $usuarios['Id']; ?>"><?php echo str_pad($usuarios['Id'], 5, "0", STR_PAD_LEFT); ?></a></td>
            ...
            <nav aria-label="Page navigatíon example">
                <ul class="pagination">
                    <li class="page-item <?php echo $_GET['pagina']<=1 ? 'disabled' : '' ?>">
                        ...
                        <a class="page-link" href="lista_mod_usuario.php?pagina=<?php echo (int)$_GET['pagina']-1; ?>">  Anterior</a>

                    </li>

                    <?php for($i=0;$i<$paginas;$i++): ?>
                        <li class="page-item <?php echo $_GET['pagina']==$i+1 ? 'active' : '' ?>">
                            <a class="page-link" href="lista_mod_usuario.php?pagina=<?php echo $i+1; ?>">
                                <?php echo $i+1; ?>
                            </a>
                        </li>
                    <?php endfor ?>
                    ...
                    <li class="page-item <?php echo $_GET['pagina']>=$paginas ? 'disabled' : '' ?>">
                        <a class="page-link" href="lista_mod_usuario.php?pagina=<?php echo (int)$_GET['pagina']+1; ?>">Siguiente</a>
                    </li>
                </ul>
            </nav>    
        </div>
