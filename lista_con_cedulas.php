...
<body>
	<div class="container  my-5">
            <h1>CONSULTA DE CEDULAS ACTIVAS</h1>
            ...
            <table class="table table-striped table-bordered">
                ...
                ?>     
                    <tr>
                        <td style="text-align: center;  width: 10%;"><a href="conCedulas.php?recordID=<?php echo $cedula['Id']; ?>"><?php echo str_pad($cedula['Id'], 5, "0", STR_PAD_LEFT); ?></a></td>
